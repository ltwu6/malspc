...
class PointsRenderer_AdaRad(nn.Module):
    """
    ...
    def forward(self, point_clouds, p_radius, **kwargs) -> torch.Tensor:
        fragments = self.rasterizer(point_clouds, p_radius, **kwargs)
        ...
        # print('shape of dists2: ', dists2.shape)
        # print('shape of r*r: ', (r*r).shape)
