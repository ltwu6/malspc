...
import os
import sys 
# sys.path.append('/home/lintaiwu_21/project/our/pointnet2_ops_lib')
...
class DGCNN(nn.Module):
    def __init__(self, k, output_channels=1):
        ...
        #                            self.bn5,
        #                            nn.LeakyReLU(negative_slope=0.2))
        self.conv5 = MLP_CONV(in_channel=512, layer_dims=[256, 64, output_channels], bn=True)
